...
test_that("support-for-tests Test 1: minimal_table: builds minimal data frame with data", {
  minimal_table(31) %>%
    NROW() %>%
    expect_equal(31)
...
test_that("support-for-tests Test 2: minimal_metadata: builds minimal metadata data frame", {
...
test_that("support-for-tests Test 3: minimal_metadata: columns in minimal_table are all in metadata", {
