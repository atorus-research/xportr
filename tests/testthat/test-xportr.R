test_that("SAS Transport file", {
  ...
  write_xport(df, path = tmp, label = "Lorem ipsum dolor sit amet")
  expect_output(str(SASxport::read.xport(tmp), "Lorem ipsum dolor sit amet"))

  write_xport(df, path = tmp, label = "Lorem ipsum dolor sit amet")
  expect_error(
    write_xport(df, tmp, label = "Lorizzle ipsizzle dolizzle pizzle go to hizzle"),
    "must be 40 characters or less")
  expect_error(
    write_xport(df, tmp, label = "Lorizzle ipsizzle dolizzl\xe7 pizzle"),
