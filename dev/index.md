...
![](reference/figures/design_flow.png)
...
[xportr](https://atorus-research.github.io/xportr/) package!
...
function can reduce duplication by setting the variable specification
and domain explicitly at the top of a pipeline. If you would like to use
...
metadata and verbosity, you can shorten it by simply using
